...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    // KC_LALT, KC_LGUI, KC_SPC,  KC_FN,  KC_SPC,  KC_RALT, KC_RCTL // For Mac
    KC_LGUI, KC_LALT, KC_SPC,  KC_FN,  KC_SPC,  KC_RALT, KC_RCTL // For Win
  ),
  [_FN] = LAYOUT(
    ...
    _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______,
